...
import (
	...
	"github.com/gogf/gf/internal/thirdparty/golang.org/x/sys/windows/svc"
	"github.com/gogf/gf/internal/thirdparty/golang.org/x/sys/windows/svc/mgr"
)
...
func TestExample(t *testing.T) {
	...
	o, err := exec.Command("go", "build", "-o", exepath, "github.com/gogf/gf/internal/thirdparty/golang.org/x/sys/windows/svc/example").CombinedOutput()
	if err != nil {
