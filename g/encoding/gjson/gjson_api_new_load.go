...
// It automatically checks the content type, creates and returns a Json object from the content.
...
func LoadIni(data interface{}, unsafe ...bool) (*Json, error) {
	return doLoadContent("ini", gconv.Bytes(data), unsafe...)
}
