...
func (c *Converter) Time(any any, format ...string) (time.Time, error) {
...
func (c *Converter) Duration(any any) (time.Duration, error) {
	// It's already this type.
...
func (c *Converter) GTime(any any, format ...string) (*gtime.Time, error) {
	if empty.IsNil(any) {
		return nil, nil
	}
