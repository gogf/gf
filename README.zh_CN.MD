...
`GoFrame`是一款强大的框架，为了更快、更轻松、更高效的项目开发。既可作为完整的应用框架，也可按需选用独立组件。

## 安装

`GoFrame`要求`Go 1.23`或更高版本。
...
- `Go`包文档：[https://pkg.go.dev/github.com/gogf/gf/v2](https://pkg.go.dev/github.com/gogf/gf/v2)
