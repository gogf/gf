...
func (r *RedisGroupSet) SIsMember(ctx context.Context, key string, member string) (int64, error) {
...
func (r *RedisGroupSet) SRem(ctx context.Context, key string, member string, members ...interface{}) (int64, error) {
	var s = []interface{}{key, member}
	s = append(s, gconv.Interfaces(members)...)
...
func (r *RedisGroupSet) SMove(ctx context.Context, source, destination, member string) (int64, error) {
...
func (r *RedisGroupSet) SMIsMember(ctx context.Context, key, member string, members ...string) ([]string, error) {
	var s = []interface{}{key, member}
	s = append(s, gconv.Interfaces(members)...)
...
func (r *RedisGroupSet) SInter(ctx context.Context, key string, keys ...string) ([]string, error) {
	var s = []interface{}{key}
...
func (r *RedisGroupSet) SUnion(ctx context.Context, key string, keys ...string) ([]string, error) {
	var s = []interface{}{key}
	s = append(s, gconv.Interfaces(keys)...)
...
func (r *RedisGroupSet) SDiff(ctx context.Context, key string, keys ...string) ([]string, error) {
	var s = []interface{}{key}
	s = append(s, gconv.Interfaces(keys)...)
