...
// SortedSet creates and returns RedisGroupSortedSet.
...
func (r *RedisGroupSortedSet) ZScore(ctx context.Context, key, member string) (float64, error) {
...
func (r *RedisGroupSortedSet) ZIncrBy(ctx context.Context, key string, increment float64, member string) (float64, error) {
...
// ZRangeOption provides options for function ZRange.
...
//
// It returns list of elements in the specified range (optionally with their scores, in case the
...
func (r *RedisGroupSortedSet) ZRange(ctx context.Context, key string, start, stop int64, option ...ZRangeOption) (*gvar.Var, error) {
	...
	return r.redis.Do(ctx, "ZRANGE", mustMergeOptionToArgs(
...
func (r *RedisGroupSortedSet) ZRank(ctx context.Context, key, member string) (*gvar.Var, error) {
...
func (r *RedisGroupSortedSet) ZRem(ctx context.Context, key string, member string, members ...string) (int64, error) {
