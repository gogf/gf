...
func (m DefaultModelInterfaceImpl) OmitEmpty() *Model {
	model := m.getModel()
...
func (m DefaultModelInterfaceImpl) OmitEmptyWhere() *Model {
	model := m.getModel()
...
func (m DefaultModelInterfaceImpl) OmitEmptyData() *Model {
	model := m.getModel()
...
func (m DefaultModelInterfaceImpl) OmitNil() *Model {
	model := m.getModel()
...
func (m DefaultModelInterfaceImpl) OmitNilWhere() *Model {
	model := m.getModel()
...
func (m DefaultModelInterfaceImpl) OmitNilData() *Model {
	model := m.getModel()
