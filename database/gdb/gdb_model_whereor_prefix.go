...
func (m DefaultModelInterfaceImpl) WhereOrPrefix(prefix string, where interface{}, args ...interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixLT(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixLTE(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixGT(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixGTE(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixBetween(prefix string, column string, min, max interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixLike(prefix string, column string, like interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixIn(prefix string, column string, in interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixNull(prefix string, columns ...string) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixNotBetween(prefix string, column string, min, max interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixNotLike(prefix string, column string, like interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixNotIn(prefix string, column string, in interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixNotNull(prefix string, columns ...string) *Model {
...
func (m DefaultModelInterfaceImpl) WhereOrPrefixNot(prefix string, column string, value interface{}) *Model {
