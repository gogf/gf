...
func (m DefaultModelInterfaceImpl) WherePrefix(prefix string, where interface{}, args ...interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixLT(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixLTE(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixGT(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixGTE(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixBetween(prefix string, column string, min, max interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixLike(prefix string, column string, like interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixIn(prefix string, column string, in interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixNull(prefix string, columns ...string) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixNotBetween(prefix string, column string, min, max interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixNotLike(prefix string, column string, like interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixNot(prefix string, column string, value interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixNotIn(prefix string, column string, in interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) WherePrefixNotNull(prefix string, columns ...string) *Model {
