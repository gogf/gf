...
func (m DefaultModelInterfaceImpl) LeftJoin(tableOrSubQueryAndJoinConditions ...string) *Model {
...
func (m DefaultModelInterfaceImpl) RightJoin(tableOrSubQueryAndJoinConditions ...string) *Model {
...
func (m DefaultModelInterfaceImpl) InnerJoin(tableOrSubQueryAndJoinConditions ...string) *Model {
...
func (m DefaultModelInterfaceImpl) LeftJoinOnField(table, field string) *Model {
...
func (m DefaultModelInterfaceImpl) RightJoinOnField(table, field string) *Model {
...
// Model("order").InnerJoinOnField("user", "user_id")
// Model("order").InnerJoinOnField("product", "product_id").
func (m DefaultModelInterfaceImpl) InnerJoinOnField(table, field string) *Model {
...
// Model("user").LeftJoinOnFields("order", "id", ">", "user_id")
// Model("user").LeftJoinOnFields("order", "id", "<", "user_id")
func (m DefaultModelInterfaceImpl) LeftJoinOnFields(table, firstField, operator, secondField string) *Model {
	return m.doJoin(joinOperatorLeft, table, fmt.Sprintf(
		`%s.%s %s %s.%s`,
		m.tablesInit,
...
// Model("user").RightJoinOnFields("order", "id", ">", "user_id")
// Model("user").RightJoinOnFields("order", "id", "<", "user_id")
func (m DefaultModelInterfaceImpl) RightJoinOnFields(table, firstField, operator, secondField string) *Model {
	return m.doJoin(joinOperatorRight, table, fmt.Sprintf(
		`%s.%s %s %s.%s`,
		m.tablesInit,
		m.db.GetCore().QuoteWord(firstField),
...
// Model("user").InnerJoinOnFields("order", "id", ">", "user_id")
// Model("user").InnerJoinOnFields("order", "id", "<", "user_id")
func (m DefaultModelInterfaceImpl) InnerJoinOnFields(table, firstField, operator, secondField string) *Model {
	return m.doJoin(joinOperatorInner, table, fmt.Sprintf(
		`%s.%s %s %s.%s`,
		m.tablesInit,
		m.db.GetCore().QuoteWord(firstField),
