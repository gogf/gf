...
func (m DefaultModelInterfaceImpl) Batch(batch int) *Model {
	model := m.getModel()
	model.batch = batch
	return model
}
...
func (m DefaultModelInterfaceImpl) Data(data ...interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) OnConflict(onConflict ...interface{}) *Model {
	if len(onConflict) == 0 {
		return m.Model
	}
	model := m.getModel()
...
//		  "nickname": "passport",
//	}).
func (m DefaultModelInterfaceImpl) OnDuplicate(onDuplicate ...interface{}) *Model {
...
//		  "password": "",
//	}).
func (m DefaultModelInterfaceImpl) OnDuplicateEx(onDuplicateEx ...interface{}) *Model {
...
// see Model.Data.
func (m DefaultModelInterfaceImpl) Insert(data ...interface{}) (result sql.Result, err error) {
	var ctx = m.GetCtx()
	if len(data) > 0 {
...
func (m DefaultModelInterfaceImpl) InsertAndGetId(data ...interface{}) (lastInsertId int64, err error) {
	var ctx = m.GetCtx()
	if len(data) > 0 {
...
// The optional parameter `data` is the same as the parameter of Model.Data function,
// see Model.Data.
func (m DefaultModelInterfaceImpl) InsertIgnore(data ...interface{}) (result sql.Result, err error) {
	var ctx = m.GetCtx()
	if len(data) > 0 {
...
// The optional parameter `data` is the same as the parameter of Model.Data function,
// see Model.Data.
func (m DefaultModelInterfaceImpl) Replace(data ...interface{}) (result sql.Result, err error) {
	var ctx = m.GetCtx()
	if len(data) > 0 {
...
func (m DefaultModelInterfaceImpl) Save(data ...interface{}) (result sql.Result, err error) {
	var ctx = m.GetCtx()
	if len(data) > 0 {
