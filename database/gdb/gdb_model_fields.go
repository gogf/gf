...
func (m DefaultModelInterfaceImpl) Fields(fieldNamesOrMapStruct ...interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) FieldsPrefix(prefixOrAlias string, fieldNamesOrMapStruct ...interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) FieldsEx(fieldNamesOrMapStruct ...interface{}) *Model {
...
func (m DefaultModelInterfaceImpl) FieldsExPrefix(prefixOrAlias string, fieldNamesOrMapStruct ...interface{}) *Model {
	model := m.doFieldsEx(
		m.getTableNameByPrefixOrAlias(prefixOrAlias),
		fieldNamesOrMapStruct...,
	)
...
func (m DefaultModelInterfaceImpl) FieldCount(column string, as ...string) *Model {
	asStr := ""
	if len(as) > 0 && as[0] != "" {
...
func (m DefaultModelInterfaceImpl) FieldSum(column string, as ...string) *Model {
	asStr := ""
	if len(as) > 0 && as[0] != "" {
		asStr = fmt.Sprintf(` AS %s`, m.db.GetCore().QuoteWord(as[0]))
	}
...
func (m DefaultModelInterfaceImpl) FieldMin(column string, as ...string) *Model {
	asStr := ""
	if len(as) > 0 && as[0] != "" {
		asStr = fmt.Sprintf(` AS %s`, m.db.GetCore().QuoteWord(as[0]))
	}
...
func (m DefaultModelInterfaceImpl) FieldMax(column string, as ...string) *Model {
	asStr := ""
	if len(as) > 0 && as[0] != "" {
		asStr = fmt.Sprintf(` AS %s`, m.db.GetCore().QuoteWord(as[0]))
	}
...
func (m DefaultModelInterfaceImpl) FieldAvg(column string, as ...string) *Model {
	asStr := ""
	if len(as) > 0 && as[0] != "" {
		asStr = fmt.Sprintf(` AS %s`, m.db.GetCore().QuoteWord(as[0]))
	}
...
func (m DefaultModelInterfaceImpl) GetFieldsStr(prefix ...string) string {
	prefixStr := ""
	if len(prefix) > 0 {
		prefixStr = prefix[0]
	}
...
func (m DefaultModelInterfaceImpl) GetFieldsExStr(fields string, prefix ...string) (string, error) {
	prefixStr := ""
	if len(prefix) > 0 {
		prefixStr = prefix[0]
	}
...
func (m DefaultModelInterfaceImpl) HasField(field string) (bool, error) {
