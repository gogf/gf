...
// Package pgsqlpgx implements gdb.Driver, which supports operations for database PostgreSQL.
//
// Note:
// 1. It needs manually import: _ "github.com/jackc/pgx/v5"
...
func init() {
	if err := gdb.Register(`pgsqlpgx`, New()); err != nil {
		panic(err)
	}
}
