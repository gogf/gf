...
const unionKnownBug = `Known bug: gdb builds unions as "(SELECT ...) UNION (SELECT ...)", but SQLite forbids parentheses around compound SELECT operands`
...
func Test_Union(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		if err != nil {
			t.Errorf("%s: %v", unionKnownBug, err)
		}
		t.AssertNil(err)
