...
func Test_Model_Update_NoWhere(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		t.AssertNE(err, nil)
		t.Assert(gstr.Contains(err.Error(), "WHERE condition statement"), true)
...
func Test_Model_Where_InvalidOperator(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		t.AssertNE(err, nil)
		t.Assert(gstr.Contains(err.Error(), "syntax error"), true)
	})
}
...
func Test_Model_Fields_InvalidField(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		t.AssertNE(err, nil)
		t.Assert(gstr.Contains(err.Error(), "no such column"), true)
	})
}
...
func Test_Model_TableNotExist(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		t.AssertNE(err, nil)
		t.Assert(gstr.Contains(err.Error(), "no such table"), true)
	})
}
...
// Test_Model_All_InvalidConnection tests query with an unopenable database file
func Test_Model_All_InvalidConnection(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		brokenDB, err := gdb.New(gdb.ConfigNode{
			Type: "sqlite",
			Link: `sqlite::@file(/no/such/directory/for/sqlite/broken.db)`,
		})
		t.AssertNil(err)

		err = brokenDB.PingMaster()
		t.AssertNE(err, nil)

		_, err = brokenDB.Model("test_table").All()
		t.AssertNE(err, nil)
		t.Assert(gstr.Contains(err.Error(), "unable to open database file"), true)
	})
}
