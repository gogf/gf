...
// PgSQL-adapted from MariaDB: supplies all NOT NULL columns required by PgSQL baseline schema.
...
// PgSQL implements Replace via ON CONFLICT DO UPDATE on the primary key.
...
// PgSQL implements Save via ON CONFLICT DO UPDATE on the primary key.
