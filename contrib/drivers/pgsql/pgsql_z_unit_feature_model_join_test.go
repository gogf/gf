...
func Test_Model_Join_FiveTables(t *testing.T) {
	var (
		table1 = "t_" + gtime.TimestampNanoStr() + "_table1"
		table2 = "t_" + gtime.TimestampNanoStr() + "_table2"
		table3 = "t_" + gtime.TimestampNanoStr() + "_table3"
		table4 = "t_" + gtime.TimestampNanoStr() + "_table4"
		table5 = "t_" + gtime.TimestampNanoStr() + "_table5"
	)
	createInitTable(table1)
	defer dropTable(table1)
	createInitTable(table2)
	...
	gtest.C(t, func(t *gtest.T) {
		...
		table6 := "t_" + gtime.TimestampNanoStr() + "_table6"
