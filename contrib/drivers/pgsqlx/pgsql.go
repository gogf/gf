...
// Package pgsqlx implements gdb.Driver using pgx driver, which supports operations for database PostgreSQL.
// This package provides access to pgx-specific features like CopyFrom, LISTEN/NOTIFY through GetPgxTx.
package pgsqlx
