...
func Test_TX_BatchReplace(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		_, err = tx.Replace(ctx, table, g.List{
			{
				"id":          2,
				"passport":    "USER_2",
				"password":    "PASS_2",
...
func Test_TX_BatchSave(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		_, err = tx.Save(ctx, table, g.List{
			{
				"id":          4,
				"passport":    "USER_4",
				"password":    "PASS_4",
...
func Test_Transaction_Spread(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		all, err := tx.Model(table).All(ctx)
		t.AssertNil(err)
