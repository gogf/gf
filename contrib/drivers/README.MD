...
```
go get -u github.com/wangyougui/gf/contrib/drivers/mysql/v2
```

Choose and import the driver to your project:
```
import _ "github.com/wangyougui/gf/contrib/drivers/mysql/v2"
```
...
## SQLite
```
import _ "github.com/wangyougui/gf/contrib/drivers/sqlite/v2"
```

## PostgreSQL
```
import _ "github.com/wangyougui/gf/contrib/drivers/pgsql/v2"
```
Note:
...
## SQL Server
```
import _ "github.com/wangyougui/gf/contrib/drivers/mssql/v2"
```
Note:
...
## Oracle
```
import _ "github.com/wangyougui/gf/contrib/drivers/oracle/v2"
```
Note:
- It does not support `Save/Replace` features.
- It does not support `LastInsertId`.
...
## ClickHouse
```
import _ "github.com/wangyougui/gf/contrib/drivers/clickhouse/v2"
```
Note:
...
## DM
```
import _ "github.com/wangyougui/gf/contrib/drivers/dm/v2"
```
Note:
- It does not support `Replace` features.
