...
func Test_SQLite_Link_MemoryDatabase(t *testing.T) {
...
func Test_SQLite_Extra_Pragmas(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_New_TwoHandlesOnSameFileWAL(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		node := gdb.ConfigNode{
			Type:  "sqlite",
...
func Test_SQLite_InsertIgnore_OrIgnore(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Replace_OrReplace(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Save_OnConflictDoUpdate(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_OnConflict_MultiColumnTarget(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Returning_Insert(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Returning_UpdateAndDelete(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_CTE_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_CTE_Recursive(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Compound_ExceptIntersect(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_Union_OperandOrderByLimit(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_UnionAll_Model(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_Window_RowNumber(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_Window_RankDenseRank(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Window_LagLead(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_Window_SumPartitionBy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_JSON1_Extract(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_JSON1_ArrowOperators(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_JSON1_ArrayLengthAndValid(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_JSON1_EachTableValued(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_JSON1_SetAndInsertInUpdate(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Type_StorageClass_Typeof(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Type_StorageClass_MixedRows(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createStorageClassTable(t, "storage_mixed")
		defer dropTable(table)
		// Note: intentionally empty. gf types a result column from its first row only, so the
		// later rows of a mixed storage class column are coerced, see
		// https://github.com/gogf/gf/issues/4895, and the rows cannot be asserted until that is fixed.
	})
}

// Test_SQLite_Type_WithoutRowid tests a WITHOUT ROWID table.
func Test_SQLite_Type_WithoutRowid(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_Type_StrictTable(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_DateTime_RawInDataAndWhere(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_DateTime_StrftimeJulianday(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
...
func Test_SQLite_GroupConcat(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_IifAndCoalesce(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_LastInsertRowid(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_OrderRandom(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_LimitNegativeOne(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
...
func Test_SQLite_ExplainQueryPlan(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		table := createInitTable()
		defer dropTable(table)
