...
var intIntMap = NewHashMap[int, int](true)

var intAnyMap = NewHashMap[int, any](true)

var intStrMap = NewHashMap[int, string](true)

var strIntMap = NewHashMap[string, int](true)

var strAnyMap = NewHashMap[string, any](true)

var strStrMap = NewHashMap[string, string](true)
