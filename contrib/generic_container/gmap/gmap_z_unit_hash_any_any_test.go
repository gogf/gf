...
func Test_AnyAnyMap_Var(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		var m = NewHashMap[exampleKey, *exampleElement]()
	...
	gtest.C(t, func(t *gtest.T) {
		var m = NewHashMap[string, string]()
		m.Set("1", "1")
...
func Test_AnyAnyMap_Basic(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		m2 := NewHashMapFrom[int, int](map[int]int{1: 1, 2: 2})
...
func Test_AnyAnyMap_Iterator(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		m := NewHashMapFrom[int, int](expect)
...
func Test_AnyAnyMap_Clone(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		// clone 方法是深克隆
		m := NewHashMapFrom[int, int](map[int]int{1: 1, 2: 2})
...
func Test_AnyAnyMap_Json(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		m1 := NewHashMapFrom[string, string](data)
...
func Test_AnyAnyMap_Pop(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewHashMapFrom[string, string](g.MapStrStr{
			"k1": "v1",
			"k2": "v2",
		})
		t.Assert(m.Size(), 2)
...
func Test_AnyAnyMap_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		n := m.DeepCopy().(*HashMap[string, string])
		n.Set("k1", "val1")
...
func Test_AnyAnyMap_IsSubOf(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m1 := NewHashMapFrom[string, string](g.MapStrStr{
			"k1": "v1",
			"k2": "v2",
		})
		m2 := NewHashMapFrom[string, string](g.MapStrStr{
			"k2": "v2",
		})
