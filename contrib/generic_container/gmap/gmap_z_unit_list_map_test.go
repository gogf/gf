...
func Test_ListMap_Var(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		var m = NewListMap[string, string]()
		m.Set("key1", "val1")
...
func Test_ListMap_Basic_Merge(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m1 := NewListMap[string, string]()
		m2 := NewListMap[string, string]()
		m1.Set("key1", "val1")
		m2.Set("key2", "val2")
		m1.Merge(m2)
		t.Assert(m1.Map(), map[interface{}]interface{}{"key1": "val1", "key2": "val2"})
		m3 := NewListMapFrom[string, string](nil)
		m3.Merge(m2)
...
func Test_ListMap_Json(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		...
		m1 := NewListMapFrom[string, string](data)
...
func Test_ListMap_Pop(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewListMapFrom(map[string]string{
			"k1": "v1",
			"k2": "v2",
		})
		t.Assert(m.Size(), 2)
...
func TestListMap_String(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		m := NewListMap[int, string]()
		m.Set(1, "")
		m.Set(2, "2")
		t.Assert(m.String(), "{\"1\":\"\",\"2\":\"2\"}")

		m1 := NewListMapFrom[int, string](nil)
		t.Assert(m1.String(), "{}")
	})
}
...
func TestListMap_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		n := m.DeepCopy().(*ListMap[int, string])
		n.Set(1, "val1")
