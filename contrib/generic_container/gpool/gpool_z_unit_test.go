...
var nf NewFunc[string] = func() (i string, e error) {
	return "hello", nil
}

var assertIndex int = 0

var ef ExpireFunc[int] = func(i int) {
	assertIndex++
...
func Test_Gpool(t *testing.T) {
	...
	gtest.C(t, func(t *gtest.T) {
		//
		// expire > 0
		p2 := New[int](2*time.Second, nil, ef)
	...
	gtest.C(t, func(t *gtest.T) {
		p := New[int](time.Millisecond*200, nil, func(i int) {})
		p.Put(1)
