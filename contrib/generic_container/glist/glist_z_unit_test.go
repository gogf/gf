...
func checkListLen[T comparable](t *gtest.T, l *List[T], len int) bool {
	if n := l.Len(); n != len {
...
func checkListPointers[T comparable](t *gtest.T, l *List[T], es []*Element[T]) {
...
func checkList[T comparable](t *gtest.T, l *List[T], es []T) {
	if !checkListLen(t, l, len(es)) {
		return
	}
...
func TestInsertBeforeUnknownMark(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		l.PushBack(2)
		l.PushBack(3)
		l.InsertBefore(new(Element[int]), 1)
...
func TestInsertAfterUnknownMark(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		l.PushBack(2)
		l.PushBack(3)
		l.InsertAfter(new(Element[int]), 1)
		checkList(t, l, []int{1, 2, 3})
	})
}
...
func TestList_Removes(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		l.PushFronts(a1)
		e1 := l.Back()
		l.Removes([]*Element[int]{e1})
		t.Assert(l.Len(), 3)

		e2 := l.Back()
		l.Removes([]*Element[int]{e2})
		t.Assert(l.Len(), 2)
...
func TestList_Pop(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		l := NewFrom([]int{1, 2, 3, 4, 5, 6, 7, 8, 9})
...
func TestList_Iterator(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		l.PushFronts(a1)
		e1 := l.Back()
		fun1 := func(e *Element[string]) bool {
