...
func ExampleNewStrSetFrom() {
	strSet := NewFrom[string]([]string{"str1", "str2", "str3"}, true)
	fmt.Println(strSet.Slice())
...
func ExampleStrSet_Complement() {
	strSet := NewFrom[string]([]string{"str1", "str2", "str3", "str4", "str5"}, true)
	s := NewFrom[string]([]string{"str1", "str2", "str3"}, true)
...
func ExampleStrSet_Diff() {
	s1 := NewFrom[string]([]string{"a", "b", "c"}, true)
	s2 := NewFrom[string]([]string{"a", "b", "c", "d"}, true)
...
func ExampleStrSet_Equal() {
	...
	s3 := NewFrom[string]([]string{"a", "b", "c"}, true)
	s4 := NewFrom[string]([]string{"a", "b", "c"}, true)
...
func ExampleStrSet_Intersect() {
	s1 := NewSet[string](true)
	s1.Add([]string{"a", "b", "c"}...)
	var s2 HashSet[string]
...
func ExampleStrSet_MarshalJSON() {
	type Student struct {
		Id     int
		Name   string
		Scores *HashSet[string]
	}
	s := Student{
		Id:     1,
		Name:   "john",
		Scores: NewFrom[string]([]string{"100", "99", "98"}, true),
	}
	b, _ := json.Marshal(s)
