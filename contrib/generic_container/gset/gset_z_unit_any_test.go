...
func TestNewFrom(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		s1 := NewFrom[string]([]string{"a"})
		s2 := NewFrom[string]([]string{"b"}, false)
		s3 := NewFrom[string]([]string{"3"}, true)
		s4 := NewFrom[string]([]string{"s1", "s2"}, true)
...
func TestSet_DeepCopy(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		...
		copySet := set.DeepCopy().(*HashSet[int])
		copySet.Add(4)
