...
```
go get -u github.com/wangyougui/gf/contrib/config/consul/v2
```
...
Note the top `import`: `_ "github.com/wangyougui/gf/example/config/consul/boot"` .

```go
package main

import (
	_ "github.com/wangyougui/gf/example/config/consul/boot"
