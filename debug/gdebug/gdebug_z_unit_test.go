...
func TestFuncPath(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(gdebug.FuncPath(TestFuncPath), "github.com/gogf/gf/v2/debug/gdebug_test.TestFuncPath")
	})
}

func TestFuncName(t *testing.T) {
	gtest.C(t, func(t *gtest.T) {
		t.Assert(gdebug.FuncName(TestFuncName), "gdebug_test.TestFuncName")
	})
}
