...
const TemplateGenTablesContent = `
// =================================================================================
// This file is auto-generated by the GoFrame CLI tool. You may modify it as needed.
// =================================================================================
...
// tables defines the list of tables that need to be managed
var tables = []string{ {{.TplTables}} }

// SetTables registers the table names to the database instance
func SetTables(ctx context.Context, db gdb.DB) error {
	return db.GetCore().SetTables(ctx, tables)
}
